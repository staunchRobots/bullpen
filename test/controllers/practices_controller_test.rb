...
class PracticesControllerTest < ActionController::TestCase
  ...
  test "should create practice" do
    assert_difference('Practice.count') do
      post :create, practice: { cv_id: @practice.cv_id, description: @practice.description, name: @practice.name }
    end
  ...
  test "should update practice" do
    patch :update, id: @practice, practice: { cv_id: @practice.cv_id, description: @practice.description, name: @practice.name }
    assert_redirected_to practice_path(assigns(:practice))
  end
